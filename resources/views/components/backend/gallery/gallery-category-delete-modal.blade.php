    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="dataGalleryCategoryDelete()" class="btn bg-danger text-light">হ্যা</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    async function dataGalleryCategoryDelete() {
        let id = document.getElementById("deleteId").value;
        let closeDeleteModal = document.getElementById("delete-modal-close");
        showLoader();
        let response = await axios.get('/admin/gallery-category-destroy/' + id);
        hideLoader();
