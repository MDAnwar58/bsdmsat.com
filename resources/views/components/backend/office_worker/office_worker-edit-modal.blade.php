            ...
            <div class="modal-body">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-7 p-3">
                        <img src="{{ url('assets/images/demo.jpg') }}" id="showImageEdit" class="w-100"
...
<script>
    function getDataForUpdate(name, position, indexNo, dateOfBirth, joiningDate, educationalQualification, address,
        ...
        showImageEdit.src = "http://localhost:8000/upload/images/office_worker/" + img;
    }
    ...
    async function updateForm() {
        ...
        if (id.length === 0) {
            ...
            showLoader();
            const response = await axios.post("/admin/office_worker-update/" + id, formData);
            hideLoader();
